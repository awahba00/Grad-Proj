...
import { Home, Bell, User, Settings, Languages, Moon, Sun, LogOut } from 'lucide-react';
      ...
      <nav className={`fixed top-0 bottom-0 ${dir === 'rtl' ? 'right-0' : 'left-0'} w-64 hidden md:flex flex-col bg-white dark:bg-gray-900 border-x border-gray-200 dark:border-gray-700 z-30`}>
        <div className="flex flex-col h-full">
          ...
          <div className="p-4 space-y-2 border-t border-gray-200 dark:border-gray-700">
            ...
            >
              <Languages className={`w-6 h-6 ${dir === 'rtl' ? 'ml-4' : 'mr-4'} flex-shrink-0`} aria-hidden="true" />
            ...
            >
              {theme === 'dark' ? (
                <Sun className={`w-6 h-6 ${dir === 'rtl' ? 'ml-4' : 'mr-4'} flex-shrink-0`} aria-hidden="true" />
              ) : (
                <Moon className={`w-6 h-6 ${dir === 'rtl' ? 'ml-4' : 'mr-4'} flex-shrink-0`} aria-hidden="true" />
              )}
